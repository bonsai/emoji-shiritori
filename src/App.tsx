...
const TEXT = {
  ja: { subtitle: "60秒で、コンボをどこまで伸ばせる？", start: "スタート", restart: "しきりなおす", menu: "メニュー", rule: "場の最後の音につながる絵文字をタップ。成功するたび +1 COMBO。時間切れか、出せなくなったら終了。", best: "自己ベスト", gameOver: "終了！", newBest: "自己ベスト更新！", moves: "手数", time: "TIME", current: "いまの絵文字", next: "次は", hand: "HAND", choice: "次の一手", noChoice: "もう出せる絵文字がない" },
